...
-- Minimal sized grid (17 Digits) with a unique solution:
...
-- Digits for that square, giving a matrix of choices:
...
-- For example, cartesianProduct [[1,2],[3,4],[5,6]] gives:
